'''Apartir de uma estrutura de vetores defida anteriormente, procurar
e exibir apenas os elementos cadastrados no qual a descrição do produto
inicia-se com a letra "R" '''
